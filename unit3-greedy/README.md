...
│   ├── Kruskal.cpp     # MST via Union-Find (Kruskal)
│   ├── Prim.cpp        # MST via vertex growth (Prim)
│   ├── fuel.cpp        # Refueling stop minimization
│   ├── latency.cpp     # Task scheduling / latency minimization
│   ├── intervals.cpp   # Interval covering
│   └── cables.cpp      # Binary merging cost minimization
